...
import { providerRateLimitRoutes } from "./routes/provider-rate-limits.js";
...
export async function createApp(
  ...
  api.use(providerRateLimitRoutes(db));
  ...
  api.use(operatorProfileRoutes(db, opts.storageService));
