...
export const ISSUE_ORIGIN_KINDS = ["manual", "routine_execution", "staffing_hiring", "org_learning_apply"] as const;
...
export const ROUTINE_TRIGGER_SIGNING_MODES = ["bearer", "hmac_sha256", "github_hmac"] as const;
