export const queryKeys = {
  companies: {
    ...
    orgIntelligence: (id: string) => ["companies", id, "org-intelligence"] as const,
  },
  companySkills: {
  ...
  issues: {
    ...
    orgIntelligence: (issueId: string) => ["issues", "org-intelligence", issueId] as const,
  ...
  providerRateLimits: (companyId: string) =>
    ["provider-rate-limits", companyId] as const,
